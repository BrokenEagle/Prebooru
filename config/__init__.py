...
TWITTER_USER_TOKEN = get_environment_variable('TWITTER_USER_TOKEN', TWITTER_USER_TOKEN)
TWITTER_CSRF_TOKEN = get_environment_variable('TWITTER_CSRF_TOKEN', TWITTER_CSRF_TOKEN)
