...
def get_pixiv_illust(illust_id):
    ...
    if data['error']:
        return create_error('pixiv_src.get_pixiv_illust', data['message'])
    return data['body']
...
def get_pixiv_artist(artist_id):
    ...
    if data['error']:
        return create_error('pixiv_src.get_pixiv_artist', data['message'])
    return data['body']
...
def get_all_pixiv_artist_illusts(artist_id):
    ...
    if data['error']:
        return create_error('pixiv_src.get_all_pixiv_artist_illusts', data['message'])
...
def get_pixiv_page_data(site_illust_id):
    ...
    if data['error']:
        return create_error('pixiv_src.get_page_data', data['message'])
