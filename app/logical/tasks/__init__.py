...
from config import EXPUNGE_CACHE_RECORDS, EXPUNGE_ARCHIVE_RECORDS, GENERATE_MISSING_IMAGE_HASHES,\
    ...
    DELETE_ORPHAN_IMAGES, VACUUM_ANALYZE_DATABASE, EXPUNGE_UNUSED_RECORDS, EXPUNGE_DUPLICATE_RECORDS
...
JOB_ITEMS =\
    [
        ...
        {
            'name': 'expunge_unused_records',
            'config': EXPUNGE_UNUSED_RECORDS,
        },
        {
            'name': 'expunge_duplicate_records',
            'config': EXPUNGE_DUPLICATE_RECORDS,
        },
        {
