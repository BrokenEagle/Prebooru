...
CREATE_ALLOWED_ATTRIBUTES = ['site', 'site_artist_id', 'current_site_account', 'site_created', 'active',
                             '_site_accounts', '_names', '_profiles']
UPDATE_ALLOWED_ATTRIBUTES = ['site', 'site_artist_id', 'current_site_account', 'site_created', 'active',
                             '_site_accounts', '_names', '_profiles']
...
def get_blank_artist():
    artist = Artist.query.filter(site=0, site_artist_id=1).one_or_none()
    if not artist:
        createparams = {
            'site': 0,
            'site_artist_id': 1,
