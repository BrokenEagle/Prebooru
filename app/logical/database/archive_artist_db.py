...
ANY_WRITABLE_COLUMNS = ['site_id', 'site_artist_id', 'site_created', 'site_account', 'name', 'profile', 'active',
...
def set_archive_artist_from_parameters(archive_artist, setparams, action, commit):
    ...
    if set_column_attributes(archive_artist, ANY_WRITABLE_COLUMNS, NULL_WRITABLE_ATTRIBUTES, setparams):
