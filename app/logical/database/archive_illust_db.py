...
ANY_WRITABLE_ATTRIBUTES = ['site_id', 'site_illust_id', 'site_artist_id', 'site_created', 'title', 'commentary',
                           'pages', 'score', 'active', 'created', 'updated', 'urls_json', 'titles_json',
                           'commentaries_json', 'additional_commentaries_json', 'tags_json', 'notations_json']
...
def set_archive_illust_from_parameters(archive_illust, setparams, action, commit):
    ...
    if set_column_attributes(archive_illust, ANY_WRITABLE_ATTRIBUTES, NULL_WRITABLE_ATTRIBUTES, setparams):
