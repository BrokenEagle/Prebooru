...
def update_subscription_pool_element_expires(subscription_pool_element, days):
    subscription_pool_element.expires = days_from_now(days) if days is not None else None
    SESSION.commit()
